...
@section('content')
    <x-admin-panel.layout>
        ...
        <div class="w-full">
            ...
            <div class="px-8 py-8 rounded-md border shadow-sm border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700">
                ...
                <div class="mb-12 flex justify-between">
                    ...
                    <form action="/admin-panel/product/{{ $product->id }}" method="POST" class="self-center">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="font-semibold w-40 border flex border-gray-200 shadow-sm py-1.5 px-2 bg-white dark:bg-gray-900 dark:border-gray-700 rounded-md hover:bg-red-700 hover:text-white dark:text-gray-400 dark:hover:border-blue-300 dark:hover:text-blue-300">
                        ...
                        <div>
                            ...
                            <div class="grid gap-4 md:grid-cols-3 md:gap-6 mt-10">
                                <div class="flex flex-col">
                                    ...
                                    <select name="state" id="" class="rounded-md bg-gray-50 border border-gray-300 focus:border-blue-600 focus:border-2 focus:ring-blue-600 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <select name="active" id="" class="rounded-md bg-gray-50 border border-gray-300 focus:border-blue-600 focus:ring-blue-600 dark:bg-gray-800 dark:border-gray-700">
                                        @if ($product->active == 0)
