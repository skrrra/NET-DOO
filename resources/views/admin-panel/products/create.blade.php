                    ...
                    <form action="/admin-panel/products" method="POST" class="grid" enctype="multipart/form-data">
                        ...
                        <div class=" grid grid-cols-3 gap-6">
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="name" class="rounded-md" placeholder="Samsung Galaxy A5">
                                @error('name')
                                    <div class="mt-2">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="amount" class="rounded-md" placeholder="12">
                                @error('amount')
                                    <div class="mt-2">
                                        <p class="text-sm text-red-400">{{ $message }}</p>
                                    </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md bg-white">
