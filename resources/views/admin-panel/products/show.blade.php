...
@section('content')    
    ...
    <x-admin-panel.layout>
        <div class="w-full bg-white rounded-md border border-gray-200 py-4 px-4 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="pb-4">
                <h1 class="text-base font-semibold uppercase">{{ $product->name }}</h1>
            </div>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-4">
                ...
                <div>
                    <div class="flex justify-between py-2 mt-4 lg:py-0 lg:mt-0">
                    ...
                    <div class="mt-4 lg:flex">
                        @foreach ($product->categories as $category)
                            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-2 py-2 rounded-md text-sm mb-2 text-center lg:mr-2 dark:hover:text-blue-300 dark:hover:border-blue-300">
                                {{ $category->name }}
                            </div>
                        @endforeach
                    </div>
